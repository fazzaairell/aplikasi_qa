    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-y-auto h-full">
        ...
        <header
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="mb-4">
                    <div class="text-[10px] text-indigo-400 font-bold tracking-widest uppercase pt-5">
                        Overview
                    </div>
        ...
        <main class="p-4 sm:p-6 lg:p-8 space-y-6 fade-in">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <!-- Total Proyek -->
                <div
                    class="stat-card rounded-2xl p-5 relative overflow-hidden"
                    style="background:#111827; border:1px solid rgba(99,102,241,0.2);">

                    <div
                        class="absolute top-4 right-4 w-10 h-10 rounded-xl flex items-center justify-center"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <!-- Test Runs Aktif -->
                <div
                    class="lg:col-span-2 rounded-2xl p-5 sm:p-6 space-y-4"
                    ...
                    <div class="space-y-3">
                        ...
                        @forelse($activeTestRuns as $run)
                            ...
                            @php
                                ...
                                $blockedWidth = $total > 0
                                    ? round($blocked / $total * 100)
                                    : 0;
                            @endphp
                            ...
                            <div
                                ...
                                style="background:#0c0f1a; border:1px solid rgba(255,255,255,0.05);">
                                ...
                                <div class="flex items-start justify-between">
                                    ...
                                    <span
                                        ...
                                        x-bind:style="'background: {{ $runDotColor }};'">
                                    </span>
                                ...
                                <div
                                    class="w-full h-1.5 rounded-full overflow-hidden flex"
                                    ...
                                    @if($total > 0)
                                        ...
                                        <div
                                            ...
                                            x-bind:style="'width: {{ $passedWidth }}%;'">
                                        </div>

                                        <div
                                            class="h-full bg-rose-500"
                                            x-bind:style="'width: {{ $failedWidth }}%;'">
                                        </div>

                                        <div
                                            class="h-full bg-amber-500"
                                            x-bind:style="'width: {{ $blockedWidth }}%;'">
                                        </div>
                                ...
                                <div class="text-[10px] text-slate-500">
                                    {{ $pct }}% selesai · {{ $untested }} belum dieksekusi
                                </div>
                ...
                <!-- Bug Terbaru -->
                <div
                    class="rounded-2xl p-5 sm:p-6 space-y-4"
                    style="background:#111827; border:1px solid rgba(255,255,255,0.06);">
                            ...
                            <div
                                ...
                                <div class="flex items-start gap-2">
                                    ...
                                    <span
                                        ...
                                        x-bind:style="'background: {{ $scText }};'">
                                    </span>

                                    <span
                                        class="text-xs font-semibold text-white leading-snug line-clamp-2">
                                ...
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span
                                        ...
                                        x-bind:style="'background: {{ $scBg }}; color: {{ $scText }}; border: 1px solid {{ $scBorder }};'">
                ...
                <div class="overflow-x-auto">
                    ...
                    <table
                        ...
                        <thead>
                            ...
                            <tr
                                class="border-b border-white/[0.06] text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                        ...
                        <tbody class="text-xs divide-y divide-white/[0.04]">
                            ...
                            @forelse($projects as $project)
                                ...
                                @php
                                    ...
                                    $bgColor =
                                        $colors[
                                            crc32($project->name) % count($colors)
                                        ];
                                @endphp
                                ...
                                <tr class="hover:bg-white/[0.02] transition">
                                    ...
                                    <td class="py-4 px-4">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div
                                                class="w-8 h-8 rounded-xl font-bold text-white flex items-center justify-center text-xs shrink-0"
                                    ...
                                    <td
                                        class="py-4 px-4 font-mono font-bold text-slate-300">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    x-bind:style="'width: {{ $pr }}%; background: {{ $prColor }};'">
                                                </div>
