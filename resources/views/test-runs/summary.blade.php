...
<header
    class="h-14 border-b sticky top-0 z-40 no-print"
...
>
    ...
    <div class="px-6 h-full flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <div
                class="w-7 h-7 rounded-lg flex items-center justify-center font-bold text-white text-xs"
...
<main class="max-w-5xl mx-auto px-6 py-8 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div>
                ...
                <div class="flex items-center gap-3 mt-1 text-xs text-slate-400">
                    ...
                    <span>
                        🗓 {{ $testRun->created_at->format('d M Y') }}
                    </span>
            ...
            @if($isReady)
                ...
                <div
                    class="verdict-ready flex items-center gap-2 px-4 py-2.5 rounded-2xl font-bold text-sm"
            ...
            @else
                ...
                <div
                    class="verdict-notready flex items-center gap-2 px-4 py-2.5 rounded-2xl font-bold text-sm"
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
        ...
        <div
            class="col-span-2 sm:col-span-3 lg:col-span-1 rounded-2xl p-5 flex flex-col justify-center items-center print-card"
        ...
        <div
            class="rounded-2xl p-4 space-y-1 print-card"
    ...
    @if($total > 0)
        ...
        <div
            class="rounded-2xl p-4 print-card"
        ...
        >
            ...
            >
                ...
                {{-- Blade tidak lagi berada di dalam style CSS --}}
                ...
                <div class="h-full flex">
                    ...
                    <div
                        ...
                        data-width="{{ $passedW }}"
                        data-background="#10b981"
                    ></div>

                    <div
                        class="progress-segment"
                        data-width="{{ $failedW }}"
                        data-background="#ef4444"
                    ></div>

                    <div
                        class="progress-segment"
                        data-width="{{ $blockedW }}"
                        data-background="#eab308"
                    ></div>

                    <div
                        class="progress-segment"
                        data-width="{{ $untestedW }}"
                        data-background="#374151"
                    ></div>
    ...
    <div>
        ...
        @if($bugs->isEmpty())
            ...
            <div
                class="rounded-2xl p-10 text-center print-card"
                style="background:#111827;border:1px solid rgba(255,255,255,0.06);"
            >

                <div class="text-slate-400 text-sm">
                    🎉 Tidak ada bug yang ditemukan dalam test run ini!
                </div>
        ...
        @else
            ...
            <div
                class="rounded-2xl border overflow-hidden print-card"
                style="background:#111827;border-color:rgba(255,255,255,0.06);"
            >

                <div class="overflow-x-auto">

                    <table
                        class="w-full text-xs print-table"
                    ...
                    >
                        ...
                        <thead>
                            ...
                            <tr
                                class="border-b"
                                style="background:rgba(12,15,26,0.6);border-color:rgba(255,255,255,0.06);"
                            >

                                <th class="px-4 py-3 text-left text-slate-400 font-semibold uppercase tracking-wider w-10">
                                    No
                                </th>

                                <th class="px-4 py-3 text-left text-slate-400 font-semibold uppercase tracking-wider min-w-[200px]">
                                    Judul Bug
                                </th>

                                <th class="px-4 py-3 text-left text-slate-400 font-semibold uppercase tracking-wider">
                                    Test Case
                                </th>
                            ...
                            @foreach($bugs as $bug)
                                ...
                                @php
                                    ...
                                    $sc = match($bug->status) {
                                        ...
                                        'Done in Review' =>
                                            'color:#d8b4fe;background:rgba(168,85,247,0.12);',
                                        ...
                                        'Reopened' =>
                                            'color:#fdba74;background:rgba(249,115,22,0.12);',
                                ...
                                >
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        @if($bug->description)
                                            ...
                                            <div class="text-slate-500 text-[10px] mt-0.5 truncate max-w-xs">
                                                {{ $bug->description }}
                                            </div>
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        ...
                                        @elseif($priority === 'Medium')
                                            ...
                                            <span
                                                class="px-2 py-0.5 rounded text-[9px] font-bold"
                                                style="background:rgba(234,179,8,0.12);color:#fde047;"
                                            >
                                                🟡 Medium
                                            </span>
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        ...
                                        {{-- Style dinamis disimpan sebagai data attribute --}}

                                        <span
                                            class="px-2 py-0.5 rounded text-[9px] font-bold bug-status"
                                            data-style="{{ $sc }}"
                                        >
                                            {{ $bug->status }}
                                        </span>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.progress-segment').forEach(function (element) {
        ...
        document.querySelectorAll('.bug-status').forEach(function (element) {
