...
<head>
    ...
    <style>
        * {
        ...
        /* Background dropdown status agar tidak putih */
        select[name="status"] {
...
<body class="h-full text-slate-100 flex overflow-hidden"
    ...
    <div
        ...
        @else
            ...
            <header class="h-16 border-b sticky top-0 z-40"
                ...
                <div class="max-w-7xl mx-auto px-8 h-full flex items-center justify-between relative">
                    ...
                    <div class="hidden md:flex flex-1 justify-center space-x-2 w-1/3">
                        ...
                        <a href="{{ route('dashboard.developer') }}"
                        ...
                        <a href="{{ route('notifications.timeline') }}"
                    ...
                    <div class="flex items-center justify-end space-x-3 w-1/3">
                        ...
                        <button type="button" @click="$dispatch('open-profile-modal')"
                            class="flex items-center space-x-3 cursor-pointer text-left" title="Buka profil">
                            ...
                            <div
                                ...
                                @if(auth()->user()->photo_path)
                                    ...
                                    <img src="{{ asset('uploads/' . auth()->user()->photo_path) }}"
        ...
        <main
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div class="flex items-center gap-3">
                    ...
                    @if($isHistory)
                        ...
                        <a href="{{ route('bugs.index') }}"
                            class="px-4 py-2.5 rounded-xl text-white text-sm font-semibold border border-white/[0.06] hover:bg-slate-800 transition"
                            style="background:#111827;">
                            ← Bugs Aktif
                        </a>
            ...
            <form method="GET" action="{{ $isHistory ? route('bugs.history') : route('bugs.index') }}"
                class="flex flex-wrap items-center gap-3 p-4 rounded-2xl border border-white/[0.06] shadow-lg"
                style="background:#111827;">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select name="status"
                        class="bg-[#0c0f1a] border border-white/[0.1] rounded-xl text-xs text-white px-3 py-1.5 focus:outline-none focus:border-indigo-500">
                        ...
                        <option value="Done in Review"
                            {{ request('status') == 'Done in Review' ? 'selected' : '' }}>
                            Done in Review
                        </option>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="date" name="date_from" value="{{ request('date_from') }}"
                        class="bg-[#0c0f1a] border border-white/[0.1] rounded-xl text-xs text-slate-300 px-3 py-1.5 focus:outline-none focus:border-indigo-500">
                ...
                <button type="submit"
                    class="px-4 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold rounded-xl transition shadow-lg shadow-indigo-600/30">
                    Terapkan Filter
                </button>

                <a href="{{ $isHistory ? route('bugs.history') : route('bugs.index') }}"
                    class="px-4 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-semibold rounded-xl transition">
                    Reset
                </a>
            ...
            <div class="rounded-2xl border border-white/[0.06] overflow-hidden" style="background:#111827;">
                    ...
                    <table class="w-full text-xs" style="min-width: 900px;" id="bugs-table">
                        ...
                        <thead>
                            ...
                            <tr class="border-b border-white/[0.06]"
                                ...
                                <th class="px-4 py-3.5 text-left text-slate-400 font-semibold uppercase tracking-wider whitespace-nowrap min-w-[140px]">
                                    Assigned To
                                </th>
                        ...
                        <tbody id="bugs-tbody">
                                    ...
                                    <td colspan="10" class="px-4 py-20 text-center">
                                        ...
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <div class="text-slate-600 text-xs">
                                                Semua bersih! Belum ada laporan bug.
                                            </div>
                            ...
                            @else
                                ...
                                @foreach($bugs as $bug)
                                    ...
                                    <tr class="bug-row border-b border-white/[0.04] transition"
                                        ...
                                        <td class="px-4 py-3.5">
                                            ...
                                            @if($bug->description)
                                                ...
                                                <div class="text-slate-500 text-[10px] truncate max-w-[200px] mt-0.5">
                                                    {{ $bug->description }}
                                                </div>
                                        ...
                                        <td class="px-4 py-3.5 whitespace-nowrap"
                                            ...
                                            @if($isHistory)
                                                ...
                                                <span class="px-3 py-1.5 rounded-lg text-[10px] font-bold"
                                                    ...
                                                    @else
                                                        style="background:rgba(168,85,247,0.1);color:#d8b4fe;border:1px solid rgba(168,85,247,0.3);"
                                                    @endif
                                                >
                                            ...
                                            @else
                                                ...
                                                <form action="{{ route('bugs.update-status', $bug->id) }}"
                                        ...
                                        <td class="px-4 py-3.5 whitespace-nowrap">
                                            ...
                                            @if($bug->assignee)
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <span class="text-slate-300 truncate max-w-[100px]">
                                                        {{ $bug->assignee->name }}
                                                    </span>
                ...
                <div class="px-4 py-3 border-t border-white/[0.04] flex items-center justify-between">
                    ...
                    <span class="text-[11px] text-slate-500" id="row-count">
                        Menampilkan {{ $bugs->count() }} bug
                    </span>

                    <span class="text-[11px] text-slate-600">
                        Total: {{ $bugs->count() }} data
                    </span>
    ...
    @if(auth()->user()->role !== 'Developer')
        ...
        <div x-show="showLaporanModal" x-cloak
            ...
            style="display:none;" @keydown.escape.window="showLaporanModal = false">
            ...
            <div @click.away="showLaporanModal = false"
                ...
                <div class="flex items-center justify-between px-6 py-4 border-b border-white/[0.06]">
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-slate-500 mt-0.5">
                            Laporkan bug yang ditemukan langsung ke Bug Tracker
                        </p>

                    </div>

                    <button @click="showLaporanModal = false" type="button"
                ...
                <form action="{{ route('bugs.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    @if(session('success'))
                        ...
                        <div class="px-4 py-3 rounded-xl text-xs font-semibold text-emerald-300"
                        ...
                        <div>
                            ...
                            <select name="assigned_to" required
                                ...
                                @foreach($developers as $dev)
                                    ...
                                    <option value="{{ $dev->id }}"
                                        {{ old('assigned_to') == $dev->id ? 'selected' : '' }}>
                                        {{ $dev->name }}
                                    </option>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div x-show="previewUrl"
                                class="relative rounded-xl overflow-hidden border border-white/[0.08]">
                                ...
                                <div class="absolute bottom-0 inset-x-0 px-3 py-1.5 text-[10px] text-white"
                    ...
                    <div class="flex justify-end gap-2 pt-2 border-t border-white/[0.06]">
                        ...
                        <button type="submit"
                            ...
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16.333A2 2 0 005.072 19H18.928A2 2 0 0020.66 16.333L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16.333A2 2 0 005.072 19H18.928" />
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document
                .querySelectorAll('select[name="status"]')
                .forEach(sel => {
